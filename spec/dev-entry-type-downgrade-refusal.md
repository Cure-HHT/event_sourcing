...
B. The downgrade-refusal check SHALL run before any write of the boot transaction, including the library-version event, view-target-versions seeding and snapshot promotion.
...
*End* *Entry-type version downgrade refusal* | **Hash**: ee97c1d7
