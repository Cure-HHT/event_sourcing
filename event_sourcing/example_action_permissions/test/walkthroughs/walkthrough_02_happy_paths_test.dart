...
void main() {
  ...
  group('Walkthrough 2: Happy paths across scope classes', () {
    ...
    test(
      'EditGreenNoteAction (site) as green-user-1 emits demo_note with workspace=green',
      () async {
        final resp = await harness.dispatch(
    ...
    test('EditBlueNoteAction (site) as blue-user emits demo_note', () async {
      final resp = await harness.dispatch(
    ...
    test(
      'PressGreenButtonAction (site) as green-user-1 emits green_button_pressed',
      () async {
        final resp = await harness.dispatch(
    ...
    test(
      'PressBlueButtonAction (site) as blue-user emits blue_button_pressed',
      () async {
        final resp = await harness.dispatch(
    ...
    test(
      'PressRedAlarmAction (self) as green-user-1 with key emits red_alarm_pressed',
      () async {
        final resp = await harness.dispatch(
