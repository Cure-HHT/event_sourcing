...
void main() {
  ...
  group('Walkthrough 1: Onboarding', () {
    ...
    test(
      'green-user-1 resolves to GreenTeam in green-workspace with 4 grants',
      () async {
    ...
    test(
      'blue-user resolves to BlueTeam in blue-workspace with 4 grants',
      () async {
    ...
    test('unknown userId resolves to Anon with empty permissions', () async {
    ...
    test('no userId also resolves to Anon with empty permissions', () async {
