...
/// atomically in one transaction. `securityDetailsOverride`, when
/// non-null, replaces `ActionContext.security` for all events written
/// by this dispatch (rare; default behavior is to use ctx.security).
