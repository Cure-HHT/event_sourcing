...
// (Action interface contract: name, description, permissions, idempotency, parseInput, validate, execute)
// Verifies: EVS-PRD-action-dispatch/B
// (execute returns ExecutionResult with events for Stage 8 atomic persist)
