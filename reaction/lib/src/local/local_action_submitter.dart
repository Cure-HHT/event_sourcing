// Implements: EVS-PRD-action-submitter — in-process ActionSubmitter
// impl: builds ActionContext from the wired-in AuthSession's active
// Principal; delegates submission to ActionDispatcher.dispatch.
