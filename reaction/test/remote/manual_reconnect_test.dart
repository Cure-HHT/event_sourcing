...
void main() {
  group('RemoteConnection.reconnect()', () {
    ...
    test('cancelling a subscription mid-reconnect does NOT send Unsubscribe on '
        'the still-unauthenticated new socket', () async {
      ...
      expect(
        secondGen.sentMessages.where((m) => m.contains('"type":"unsubscribe"')),
        isEmpty,
